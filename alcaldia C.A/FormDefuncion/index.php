...
$consulta_precio = "SELECT * FROM precios_doc where nombre_documento = 'partida_autentica_FormDefuncion' ";
$row = mysqli_query($con,$consulta_precio);
$precio_doc_autentica = mysqli_fetch_assoc($row);
// precio partida
$consulta_precio = "SELECT * FROM precios_doc where nombre_documento =  'partida_normal_FormDefuncion' ";
$row = mysqli_query($con,$consulta_precio);
...
<body>
    <div class="container">
        ...
        <h1 class="logo">Partida de <span>Defunción</span></h1>
            ...
            <div class="contact-form">
               ...
               <p name="info" class="infor" style="max-width:50%;width:auto;height:auto;">Normal: $<?php echo $precio_doc_patida['precio']  ?></p>
                <form id="datos" method="post" action="pagina.php" >
                    ...
                    <p>
                        <label for="start">Fecha de muerte:</label>
