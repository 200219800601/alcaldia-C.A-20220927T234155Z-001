...
$consulta_precio = "SELECT * FROM precios_doc where nombre_documento = 'partida_autentica_FormMatrimonio' ";
$row = mysqli_query($con,$consulta_precio);
$precio_doc_autentica = mysqli_fetch_assoc($row);
// precio partida
$consulta_precio = "SELECT * FROM precios_doc where nombre_documento =  'partida_normal_FormMatrimonio' ";
$row = mysqli_query($con,$consulta_precio);
...
<body>
    <div class="container">
        ...
        <h1 class="logo">Partida de <span>Matrimonio</span></h1>
            ...
            <div class="contact-form">
               ...
               <p name="info" class="infor" style="max-width:50%;width:auto;height:auto;">Normal: $<?php echo $precio_doc_patida['precio']  ?></p>
                <form id="datos" method="post" action="pagina.php" >
                    ...
                    <p>
                        <label for="start">Fecha de matrimonio:</label>

                        <span class="fecha"></span><input type="date" id="start" name="trip-start"
                           value="aaaa-mm-dd"
                             min="1900-01-01" max="2025-12-31" required></span>

                    </p> 
                    <p>
                        <label for="surnames">Nombre del conyuge</label>
                        <input type="text" name="conyuge" id="surnames" placeholder="Nombre completo" required>
                    </p>
