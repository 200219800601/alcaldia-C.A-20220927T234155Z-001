...
// precio partida autentica
    ...
    $fecha_matrimonio = mysqli_real_escape_string($con,$_REQUEST['trip-start']??'') ;
    $nombre_conyuge = mysqli_real_escape_string($con,$_REQUEST['conyuge']??'') ;
    ...
    $query_insertar_matrimonio ="INSERT INTO partida_de_matrimonio(Nombre_titular,Fecha_matrimonio,Nombre_conyuge,
    Dia_retiro,Hora_retiro,Telefono,Email,DUI)
     VALUES ('".$nombre_titular."','".$fecha_matrimonio."','".$nombre_conyuge."','".$dia_cita."','".$hora_retiro."','".$phone."','".$email."',
     '".$dui."')";
   
      $res = mysqli_query($con,$query_insertar_matrimonio);
   
     
  
   if ($res) {
   
    $consulta = "SELECT * FROM partida_de_matrimonio where Telefono = '".$phone."' ";
    $row = mysqli_query($con,$consulta);
    $id_matrimonio = mysqli_fetch_assoc($row);
        ...
        <div style=" background-color: #0a568e" class="contact-form"><br><p class="title" style=" text-align: center; font-size: large;">Cita reservada con los siguientes datos: <br>(¡Tomar captura como comprobante de reservacion!) </p><br></div>
               ...
               <h3 >Datos personales</h3>
                <p>
                    <label for="" style="text-align:right; color: black;">Nombre del titular:
                         <span style="color:#0a568e ;"><?php  echo $id_matrimonio['Nombre_titular'] ?></span> </label>
               </p>
               <p>
                <label for="" style="text-align:right; color: black;">Fecha de matrimonio:
                    <span style="color: #0a568e ;"><?php  echo $id_matrimonio['Fecha_matrimonio'] ?></span> </label>
               </p>
               <p>
                <label for="" style="text-align:right; color: black;">Nombre del conyuge:
                     <span style="color: #0a568e ;"><?php  echo $id_matrimonio['Nombre_conyuge'] ?></span> </label>
               </p>
               ...
               <p>
                <label for="" style="text-align:center; color: black;">Dia retiro:
                      <span style="color:#0a568e;"><?php  echo $id_matrimonio['Dia_retiro'] ?></span> </label>
               </p>
               <p>
                <label for="" style="text-align:center; color: black;">Hora de retiro: 
                     <span style="color: #0a568e ;"><?php  echo $id_matrimonio['Hora_retiro'] ?></span> </label>
               </p>
               <p>
                <label for="" style="text-align:center; color: black;">Telefono: 
                     <span style="color: #0a568e ;"><?php  echo $id_matrimonio['Telefono'] ?></span> </label>
               </p>
               <p>
                <label for="" style="text-align:center; color: black;">Email: 
                    <span style="color: #0a568e ;"><?php  echo $id_matrimonio['Email'] ?></span> </label>
               </p>
               <p>
                <label for="" style="text-align:center; color: black;">DUI: 
                     <span style="color: #0a568e ;"><?php  echo $id_matrimonio['DUI'] ?></span> </label>
               </p>
