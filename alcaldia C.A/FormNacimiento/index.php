...
$consulta_precio = "SELECT * FROM precios_doc where nombre_documento = 'partida_autentica_Formnacimiento' ";
$row = mysqli_query($con,$consulta_precio);
$precio_doc_autentica = mysqli_fetch_assoc($row);
// precio partida
$consulta_precio = "SELECT * FROM precios_doc where nombre_documento =  'partida_normal_Formnacimiento' ";
$row = mysqli_query($con,$consulta_precio);
$precio_doc_normal = mysqli_fetch_assoc($row);
...
<body>
    <div class="container">
        ...
        <h1 class="logo">Partida de <span>Nacimiento</span></h1>
        ...
        <div class="contact-wrapper animated bounceInUp">
            <div class="contact-form">
               ...
               <p name="info" class="infor" style="max-width:50%;width:auto;height:auto;">Normal: $<?php echo $precio_doc_normal['precio']  ?>, Autentico: $<?php echo $precio_doc_autentica['precio']  ?></p>
