...
$consulta_precio = "SELECT * FROM precios_doc where nombre_documento = 'partida_autentica_FormSolteria' ";
$row = mysqli_query($con,$consulta_precio);
$precio_doc_autentica = mysqli_fetch_assoc($row);
// precio partida
$consulta_precio = "SELECT * FROM precios_doc where nombre_documento =  'partida_normal_FormSolteria' ";
$row = mysqli_query($con,$consulta_precio);
...
<head>
    ...
    <title>Certificado de Solteria</title>
    <!-- SweetAlert -->  
...
<body>
    <div class="container">
        ...
        <h1 class="logo">Certificado de <span>Soltería</span></h1>
        ...
        <div class="contact-wrapper animated bounceInUp">
            <div class="contact-form">
               ...
               <form id="datos" method="post" action="pagina.php" >
                    <p>
                        <label for="names">Nombre del titular del certificado</label>
                    ...
                    <p>
                        ...
                        <input type="text" name="nombre_padre" id="fullname" placeholder="Nombre completo" required>
                    </p>   
                    <p>
                        <label for="fullname">Nombre Madre</label>
                        <input type="text" name="nombre_madre" id="fullname" placeholder="Nombre completo" required>
                    </p>
